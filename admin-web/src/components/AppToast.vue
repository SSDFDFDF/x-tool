...
import { hideToast, toastState } from '../utils/toast'
    ...
    >
      <div class="flex items-start gap-3 p-4">
        ...
        <div class="min-w-0 flex-1">
          <div v-if="toastState.title.value" class="text-sm font-semibold">
            {{ toastState.title.value }}
          </div>
